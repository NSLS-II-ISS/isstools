...
class ScanGui(*uic.loadUiType(ui_path)):
    ...
    def __init__(self, plan_funcs = [],
        ...
        if len(self.adc_list):
            ...
            self.comboBox_samp_time.currentTextChanged.connect(self.widget_run.setAnalogSampTime)
        ...
        if len(self.enc_list):
            ...
            self.lineEdit_samp_time.textChanged.connect(self.widget_run.setEncSampTime)
        ...
        if hasattr(self.xia, 'input_trigger'):
            if self.xia.input_trigger is not None:
                ...
                self.lineEdit_xia_samp.textChanged.connect(self.widget_run.setXiaSampTime)
