...
if platform == 'darwin':
    ui_path = pkg_resources.resource_filename('isstools', 'ui/ui_xview_databroker-mac.ui')
else:
    ui_path = pkg_resources.resource_filename('isstools', 'ui/ui_xview_databroker.ui')
